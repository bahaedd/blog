    ...
    public function GenerateRandom(Request $request)
{
    ...
    public function EmailAddressValidation() {
        ...
        return view("blog.toolsv2.multiple-email-validator", compact('hidden', 'data'));

    }

    //Multiple Email Validator
    public function multipeEmailValidator() {
    ...
    public function fileEmailValidator() {
    ...
    public function CheckFileEmails(Request $request) {
