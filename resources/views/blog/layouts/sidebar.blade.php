        ...
        <div class="w-full flex flex-col max-w-sm px-8 py-6 mx-auto bg-white rounded-lg border border-gray-200 shadow-md dark:border-gray-700 my-4 dark:bg-gray-800">
            ...
            <div class="flex items-center justify-between mt-4">
                <div class="flex items-center">
                    <a href="{{url('category', $category->slug)}}"class="mx-3 text-sm font-semibold text-white bg-green-700 rounded md:bg-transparent md:text-green-700 md:p-0 dark:text-gray-400 hover:underline ml-3">{{ $category->name }}</a>
                </div>
            </div>
            @endforeach
        </div> --}}
