...
@section('content')
 <!-- container -->
        <div class="container mx-auto py-3 mt-12 mb-12 dark:bg-gray-800">
            <h2 class="my-4 text-xl text-center font-bold text-white bg-green-700 rounded md:bg-transparent md:text-green-700 md:p-0 dark:text-gray-400 uppercase">{{ $tag->name }} POSTS</h2>
