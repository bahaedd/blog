                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 border border-gray-700">
                        <caption class="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800 border border-gray-700">
                            <span class="text-yellow-400">
                                <ion-icon name="location" size="large"></ion-icon> {{ $city }}, Morocco
                            </span>
                        </caption>
                        <thead class="text-xs text-gray-900 uppercase bg-yellow-300 dark:bg-yellow-300 dark:text-gray-900">
                            <tr>
                        ...
                        <tbody>
                            @for ($i = 0; $i < count($data['data']); $i++) <tr class="@if($data['data'][$i]['date']['gregorian']['day'] == $data['data'][$today-1]['date']['gregorian']['day']) text-gray-900 uppercase bg-yellow-300 dark:bg-yellow-300 dark:text-gray-900 @else bg-white border-b dark:bg-gray-800 @endif dark:border-gray-700">
