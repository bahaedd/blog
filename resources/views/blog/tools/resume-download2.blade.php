                    ...
                    <div class="w-full max-w-6xl mx-auto px-4 py-8 flex justify-between md:flex-no-wrap flex-wrap">
                        <header class="inline-flex items-baseline justify-between w-full align-top border-b border-green-600">
                            ...
                            <div class="mt-12">
                                ...
                                <img src="{{URL('/storage/profiles/'.$personal_informations->image)}}" class="max-w-full rounded-lg pt-12" alt="{{ $personal_informations->name }}" width="200" height="130">
                                @else
                                <img src="{{URL('/images/guest.jpg')}}" class="rounded w-32 h-96 p-3 m" alt="Profile picture" width="230" height="160">
                                @endif
                            </div>
                        </header>
