...
<body class="bg-white dark:bg-gray-800">
    ...
    <div class="px-16 mx-auto py-16 md:py-20 mb-6 mt-12" style="direction: rtl;">
        <h2 class="my-4 mb-12 text-4xl text-center font-semibold text-green-700 rounded md:bg-transparent md:text-green-700 md:p-0 dark:text-green-700">أذكار بعد الصلاة</h2>
