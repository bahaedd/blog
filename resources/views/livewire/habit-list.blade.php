                        ...
                        <div class="w-full bg-white border rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div id="fullWidthTabContent" class="border-t border-gray-200 dark:border-gray-600">
                                <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="all" role="tabpanel" aria-labelledby="all-tab">
                                    <div class="w-full p-12 bg-white border rounded-lg shadow-md sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                                                ...
                                                <div id="accordion-collapse" data-accordion="collapse">
                                                    <h2 id="accordion-collapse-heading-1">
                                                        <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                                                            ...
                                                            <button type="submit" data-accordion-target="#accordion-collapse-body-1" aria-expanded="true" aria-controls="accordion-collapse-body-1" class="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-xs font-medium text-gray-500 bg-gray-200 rounded dark:bg-gray-700 dark:text-gray-400">Popular</button>
                                                        </a>
                                                    </h2>
                                ...
                                <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="personal" role="tabpanel" aria-labelledby="personal-tab">
                                    <div class="w-full p-12 bg-white border rounded-lg shadow-md sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                                        <ul class="my-4 space-y-3">
                                            <li>
                                                <div id="accordion-collapse" data-accordion="collapse">
                                ...
                                <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="work" role="tabpanel" aria-labelledby="work-tab">
                                    <div class="w-full p-12 bg-white border rounded-lg shadow-md sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                                        <ul class="my-4 space-y-3">
                                            <li>
                                                <div id="accordion-collapse" data-accordion="collapse">
                                ...
                                <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="others" role="tabpanel" aria-labelledby="others-tab">
                                    <div class="w-full p-12 bg-white border rounded-lg shadow-md sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                                        <ul class="my-4 space-y-3">
                                            <li>
                                                <div id="accordion-collapse" data-accordion="collapse">
